...
RLF = "14.7027566005"               # Rate of Laying Pheromone
...
##### Using Simulation Script to manage the following parameters with setParams() #####

VISUAL =            False

# Fake Food Loop Function Settings **
USE_FF_DOS =        0                  # Turn on/off fake_food DoS
FFD =               0                       # Fake Food Distribution Mode (0=Random, 1=Cluster, 2=PowerLaw)
NUM_FF =            0                      # Number of fake food to distribute for random distribution
NUM_FCL =           0                       # Number of fake food clusters for cluster distribution
FCL_X =             0                       # Fake cluster width X for cluster distribution
FCL_Y =             0                       # Fake cluster width Y for cluster distribution
NUM_PLAW_FF =       0                     # Number of fake food to distribute for power law distribution

# Real Food Loop Function Settings
RFD =               0                       # Real Food Distribution Mode (0=Random, 1=Cluster, 2=PowerLaw)
NUM_RF =            0                      # Number of real food to distribute for random distribution
NUM_RCL =           0                       # Number of real food clusters for cluster distribution
RCL_X =             0                       # Real cluster width X for cluster distribution
RCL_Y =             0                       # Real cluster width Y for cluster distribution
NUM_PLAW_RF =       0                     # Number of real food to distribute for power law distribution

############################################################

# used to update global parameters after initial compilation
def setParams(  use_ff_dos, ffd, num_ff, num_fcl, fcl_x, fcl_y, num_plaw_ff,
                rfd, num_rf, num_rcl, rcl_x, rcl_y, num_plaw_rf, visual):
    VISUAL = visual
    USE_FF_DOS = use_ff_dos
    FFD = ffd
    NUM_FF = num_ff
    NUM_FCL = num_fcl
    FCL_X = fcl_x
    FCL_Y = fcl_y
    NUM_PLAW_FF = num_plaw_ff
    RFD = rfd
    NUM_RF = num_rf
    NUM_RCL = num_rcl
    RCL_X = rcl_x
    RCL_Y = rcl_y
    NUM_PLAW_RF = num_plaw_rf
...
def createXML():
    ...
    lf_cpfa.setAttribute('RateOfLayingPheromone', str(RLF))
...
# NUM_PLAW_RF =       128                     # Number of fake food to distribute for power law distribution
...
# NUM_PLAW_FF =       256                     # Number of real food to distribute for power law distribution

#########################################################

# # Fake Food Loop Function Settings **
# USE_FF_DOS =        DoS_simulation.USE_FF_DOS                  # Turn on/off fake_food DoS
# FFD =               DoS_simulation.FFD                       # Fake Food Distribution Mode (0=Random, 1=Cluster, 2=PowerLaw)
# NUM_FF =            DoS_simulation.NUM_FF                      # Number of fake food to distribute for random distribution
# NUM_FCL =           DoS_simulation.NUM_FCL                       # Number of fake food clusters for cluster distribution
# FCL_X =             DoS_simulation.FCL_X                       # Fake cluster width X for cluster distribution
# FCL_Y =             DoS_simulation.FCL_Y                       # Fake cluster width Y for cluster distribution
# NUM_PLAW_RF =       DoS_simulation.NUM_PLAW_RF                     # Number of fake food to distribute for power law distribution

# # Real Food Loop Function Settings
# RFD =               DoS_simulation.RFD                       # Real Food Distribution Mode (0=Random, 1=Cluster, 2=PowerLaw)
# NUM_RF =            DoS_simulation.NUM_RF                      # Number of real food to distribute for random distribution
# NUM_RCL =           DoS_simulation.NUM_RCL                       # Number of real food clusters for cluster distribution
# RCL_X =             DoS_simulation.RCL_X                       # Real cluster width X for cluster distribution
# RCL_Y =             DoS_simulation.RCL_Y                       # Real cluster width Y for cluster distribution
# NUM_PLAW_FF =       DoS_simulation.NUM_PLAW_RF                     # Number of real food to distribute for power law distribution